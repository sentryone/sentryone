# SQL SENTRY, LLC, d/b/a SENTRYONE Entity Contributor License Agreement #
Thank you for your interest in contributing to SQL SENTRY, LLC, d/b/a SENTRYONE ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by email, following the instructions at https://github.com/sentryone/sentryone/blob/master/contributing.md. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in https://github.com/sentryone/sentryone/blob/master/contributing.md.
...
(d) You have followed the instructions in https://github.com/sentryone/sentryone/blob/master/contributing.md, if You do not own the Copyright in the entire work of authorship Submitted.
...
## 6. Miscellaneous
### 6.1
This Agreement will be governed by and construed in accordance with the laws of State of North Carolina excluding its conflicts of law provisions. Under certain circumstances, the governing law in this section might be superseded by the United Nations Convention on Contracts for the International Sale of Goods ("UN Convention") and the parties intend to avoid the application of the UN Convention to this Agreement and, thus, exclude the application of the UN Convention in its entirety to this Agreement.
...
Address: ________________
________________________
_Harmony (HA-CLA-E) Version 1.0_
